    ...
    <section class="home">
        ...
        <div class="content mx-5">
            <div class="content-preview d-flex align-items-center py-2">
                ...
                <a href="../Admin/CreateProduct.php">Create Product</a>
            </div>
            <div class="content-form py-2">
                <form action="">
                    ...
                    <div class="d-flex py-2">
                        <div class="mb-3 w-50">
                            <label for="price" class="form-label">Stock Product</label>
                            <input type="number" id="stock" class="form-control form-control-lg">
                        </div>
                        <div class="mb-3 w-50">
                            <label for="price" class="form-label">Kategori Product</label>
